# Generated by Django 5.0.6 on 2024-12-19 17:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Iranian', 'ایرانی'), ('FastFood', 'فست فود'), ('Drink', 'نوشیدنی'), ('Dessert', 'دسر'), ('Appetizer', 'پیش غذا')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='admin_account', to='main.customuser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='employee_account', to='main.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
